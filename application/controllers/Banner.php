...
class Banner extends CI_Controller {
    ...
    public function save_add() {
        ...
        $uploaded = $this->_upload_file('banners_image', './uploads/banners/');
        $ban_video = $this->_upload_video('banner_video', './uploads/banner_video/');
        ...
        $payload = [
            ...
            'banners_image'    => $uploaded,
            'banner_video'    => $ban_video
    ...
    public function save_edit($id) {
        ...
        $uploaded = $this->_upload_file('banners_image', './uploads/banners/', 'jpg|jpeg|png|webp', $banner->banners_image);
        $ban_video = $this->_upload_file('banner_video', './uploads/banner_video/', 'mp4|mov|avi|mkv', $banner->banner_video);
