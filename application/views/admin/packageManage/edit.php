...
<div class="col-md-4 mb-3">
    ...
    <div class="mb-3">
        ...
        <textarea name="meta_description" id="meta_description" class="form-control" rows="4"><?= $package->meta_description; ?></textarea>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            ...
            <select name="accommodation" class="form-select">
                ...
                <option <?= ($package->accommodation == "5 Star Hotel") ? "selected" : "" ?>>5 Star Hotel</option>
                <option <?= ($package->accommodation == "4 Star Hotel") ? "selected" : "" ?>>4 Star Hotel</option>
                <option <?= ($package->accommodation == "Resort") ? "selected" : "" ?>>Resort</option>
                <option <?= ($package->accommodation == "Villa") ? "selected" : "" ?>>Villa</option>
            </select>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            ...
            <select name="group_size" class="form-select">
                <option value="">Select</option>
                <option <?= ($package->group_size == "1-10") ? "selected" : "" ?>>1-10</option>
                <option <?= ($package->group_size == "10-20") ? "selected" : "" ?>>10-20</option>
                <option <?= ($package->group_size == "20-40") ? "selected" : "" ?>>20-40</option>
            </select>
        </div>
        ...
        <div class="col-md-4 mb-3">
            ...
            <select name="animal" class="form-select">
                <option value="">Select</option>
                <option <?= ($package->animal == "Cat") ? "selected" : "" ?>>Cat</option>
                <option <?= ($package->animal == "Dog") ? "selected" : "" ?>>Dog</option>
                <option <?= ($package->animal == "Pet Only") ? "selected" : "" ?>>Pet Only</option>
            </select>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            ...
            <select name="age_range" class="form-select">
                <option value="">Select</option>
                <option <?= ($package->age_range == "18-45") ? "selected" : "" ?>>18-45</option>
                <option <?= ($package->age_range == "18-55") ? "selected" : "" ?>>18-55</option>
                <option <?= ($package->age_range == "All Ages") ? "selected" : "" ?>>All Ages</option>
            </select>
        </div>
        ...
        <div class="col-md-4 mb-3">
            ...
            <select name="season" class="form-select">
                <option value="">Select</option>
                <option <?= ($package->season == "Winter Season") ? "selected" : "" ?>>Winter Season</option>
                <option <?= ($package->season == "Summer Season") ? "selected" : "" ?>>Summer Season</option>
                <option <?= ($package->season == "Rainy Season") ? "selected" : "" ?>>Rainy Season</option>
            </select>
        </div>
        ...
        <div class="col-md-4 mb-3">
            ...
            <select name="tour_type" class="form-select">
                <option value="">Select</option>
                <option <?= ($package->tour_type == "Adventure") ? "selected" : "" ?>>Adventure</option>
                <option <?= ($package->tour_type == "Family") ? "selected" : "" ?>>Family</option>
                <option <?= ($package->tour_type == "Honeymoon") ? "selected" : "" ?>>Honeymoon</option>
                <option <?= ($package->tour_type == "Luxury") ? "selected" : "" ?>>Luxury</option>
            </select>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const editors = [
            'description', 'meta_description', 'day_details',
