...
<div id="step1" class="step-card">
    <div class="row">
     ...
     <div class="col-md-4 mb-3">
            ...
            <input type="text" name="destinations" class="form-control" value="<?php echo set_value('destinations'); ?>">
        </div>
      </div>  
    <div class="mb-3">
...
<div id="step2" class="step-card d-none">
    <div class="form-group mb-3">
        ...
        <textarea name="day_details" id="day_details" class="form-control" rows="4"><?php echo set_value('day_details'); ?></textarea>
    </div>

    <div class="form-group mb-3">
        <label>Highlights of Tour</label>
        <textarea name="highlights_of_tours" id="highlights_of_tours" class="form-control" rows="4"><?php echo set_value('highlights_of_tours'); ?></textarea>
    </div>
...
<div id="step3" class="step-card d-none">
    ...
    <div class="form-group mb-3">
        <label>Note</label>
        <textarea name="note" id="note" class="form-control" rows="4"><?php echo set_value('note'); ?></textarea>
    </div>
    <div class="text-end">
...
document.addEventListener('DOMContentLoaded', function() {
    const editors = ['description','meta_description','day_details','highlights_of_tours','additional_info','inclusion','exclusion','addtional_charge','note'];
...
<script>
    ...
    if (category !== '') {
        ...
        $.ajax({
            url: "<?= base_url('admin/package/get_location/'); ?>" + category,
            type: "GET",
            dataType: "json",
