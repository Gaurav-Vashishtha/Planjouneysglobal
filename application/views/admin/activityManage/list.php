...
<form method="get" class="row g-2 mb-3">
    <div class="col-auto">
        <select name="category" class="form-select">
            ...
            <option value="asia" <?php echo (isset($filters['category']) && $filters['category']=='asia')?'selected':''; ?>>Asia</option>
            <option value="africa" <?php echo (isset($filters['category']) && $filters['category']=='africa')?'selected':''; ?>>Africa</option>
            <option value="oceania" <?php echo (isset($filters['category']) && $filters['category']=='oceania')?'selected':''; ?>>Oceania</option>
            <option value="middle_east" <?php echo (isset($filters['category']) && $filters['category']=='middle_east')?'selected':''; ?>>Middle East</option>
            <option value="north_america" <?php echo (isset($filters['category']) && $filters['category']=='north_america')?'selected':''; ?>>North America</option>
        </select>
    </div>
    <div class="col-auto">
