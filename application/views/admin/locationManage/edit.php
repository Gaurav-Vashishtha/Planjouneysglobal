...
<div class="row">
    ...
    <div class="col-md-4 mb-3">
        ...
        <select name="category" class="form-select">
            ...
            <option value="middle_east" <?= ($location->category == 'middle_east') ? 'selected' : ''; ?>>Middle East</option>           
            <option value="north_america" <?= ($location->category == 'north_america') ? 'selected' : ''; ?>>North America</option>
        </select>
    </div>
    ...
    <div class="col-md-4 mb-3">
    <label class="form-label">Location Icon <small>(Max size: 5 MB)</small></label>
...
<div class="row">
    <div class="col-md-6 mb-3">
        <label>Main Image <small>(Max size: 5 MB)</small></label><br>
        <?php if ($location->image): ?>
            <img src="<?php echo base_url('' . $location->image); ?>"
...
<div class="col-md-6 mb-3">
    <label>Gallery Images <small>(Max size: 5 MB)</small></label><br>
...
<div class="mb-3">
    <label>Video <small>(Max size: 4 MB)</small></label><br>
    <?php if ($location->video): ?>
        <video src="<?php echo base_url('' . $location->video); ?>"
                ...
                <div class="best-time-item border p-3 mb-3 position-relative">
                    ...
                    <div class="mt-2">
                        ...
                        <?php if (!empty($bt['image'])): ?>
                            <img src="<?php echo base_url('' . $bt['image']); ?>"
