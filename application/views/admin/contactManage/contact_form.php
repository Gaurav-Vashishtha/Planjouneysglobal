...
<script>
    ClassicEditor.create(document.querySelector('#meta_title')).catch(err => console.error(err));
    ClassicEditor.create(document.querySelector('#meta_discription')).catch(err => console.error(err));
</script>
